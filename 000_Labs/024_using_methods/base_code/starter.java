...
class starter {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		populateArrayList();
			System.out.println("it is " + getTime() + " right now! it is time to type!\nwe give you a sentence you better type it fast!\n\n------------------------------------------------------------------------------------------------------------------------------------------------");
			System.out.println("you can choose 3 options what do you want\n 1. random sentence\n 2. play a set\n 3. Quit.");
			int pick = sc.nextInt();
			sc.nextLine();
			if(pick==1){
				System.out.println("okay a random sentence will appear\n\n--------------------Your Sentence:--------------------\n" + getSentence() + "\n------------------------------------------------------");
				countdown();
				startTimer();
				
				String word = sc.nextLine();
				
				System.out.println("Good job this is your stats:");
				System.out.println("Time: " + endTimer() + "\nErrors: " + compareSentences(getSentence(), word) + "\n" + lettersInSentence(word)/endTimer() + " letters per minute\n" + wordsInSentence(word)/endTimer() + " words per minute\n--------------------------------------------------------------");
			}
		}
