		...
		*/
		while(true){
			...
			if(choice.equals("file"))
				...
				System.out.println("how much words of text would you like to print?");
				int num = sc.nextInt();
				sc.nextLine();
				...
				System.out.println();
				int ahh = checksArray(arr,check);
				System.out.println("'" + check + "' is found " + ahh + " times in " + textFile);
			}
