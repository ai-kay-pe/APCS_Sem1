        ...
        */
        ...
        if(diff == 1){
            ...
            for(int y = 0; y<x; y++){
                ...
                color[y] = getColorWord();
                Colors.println(color[y]);
            }System.out.println("---------------------------\nMemorize this: ");
            delay(5);
            System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
            for(int y = 0; y<x; y++){
                ...
                if (ans.equals(color[y].toLowerCase())){
                    fail = false;
                }
                else{
                    System.out.println("you got it wrong, the anser was: ");
                            printArray(color);
                    fail = true;
                    break;
                }
            ...
            if (fail) break;
            else System.out.println("WOW YOU GOT IT RIGHT!");
            }
        }
            /*
                Difficulty level 1:
            ...
            */
            ...
            x++;
            String[] color = new String[x];
            String[] color1 = new String[x];
            System.out.println("---------------------------");
            for(int y = 0; y<x; y++){
               
                color[y] = getColorWord();
                color1[y] = getColorWord();
                Colors.println(color[y], color1[y]);
            }System.out.println("---------------------------\nMemorize this: ");
            delay(5);
            System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
            ...
            if(guess==1){
                System.out.println("Give me the text color: ");
                for(int y = 0; y<x; y++){
                    ans = sc.nextLine().toLowerCase().trim();
                
                    if (ans.equals(color1[y].toLowerCase())){
                        fail = false;
                    }
                    else{
                        System.out.println("you got it wrong, the anser was: ");
            ...
            */
            ...
            String[] color = new String[x];
            String[] color1 = new String[x];
            String[] color2 = new String[x];
            System.out.println("---------------------------");
            for(int y = 0; y<x; y++){
               
                color[y] = getColorWord();
                color1[y] = getColorWord();
                color2[y] = getColorWord();
                Colors.println(color[y], color1[y], color2[y]);
            }System.out.println("---------------------------\nMemorize this: ");
            delay(5);
            System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
            ...
            if (guess==2){
                System.out.println("Give me the backround color: ");
                    for(int y = 0; y<x; y++){
                   ans = sc.nextLine().toLowerCase().trim();
                
                    if (ans.equals(color2[y].toLowerCase())){
                        fail = false;
                    }
                    else{
                        System.out.println("you got it wrong, the anser was: ");
